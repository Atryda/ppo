...
//								zrobiæ walidatory, rok na rzymski, ³adne menu,
using namespace std;
	...
	while(wybor!=3)
	{
		...
		switch(wybor)
		{
			case 1:
				...
				cout << " ";
			/*	cout << students.at(i).getpesel();
				cout << " ";*/
				cout << students.at(i).getAdres();
				cout << " ";
				cout << students.at(i).getRok();
				cout << " ";
			...
			case 2:
				...
				student.setSurname();
				student.setPesel();
				cout << "Chcesz podaæ adres? t/n"<<endl;
				cin>>taknie;
				if(taknie=="t")
				student.setAdres();
				cout << "Chcesz podaæ rok? t/n"<<endl;
				cin>>taknie;
				if(taknie=="t")
				student.setRok();
